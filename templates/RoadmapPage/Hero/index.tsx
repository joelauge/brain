    ...
    <Section>
        <div className="container md:pt-10 lg:pt-16 xl:pt-20">
            <Heading
                ...
                titleLarge="Our (Approach to) Projects"
                textLarge="Our proven AI consulting methodology guides businesses through successful AI implementation, from discovery to deployment."
            >
                <Button
