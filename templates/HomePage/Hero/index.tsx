            ...
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto mb-[3.875rem] text-center md:mb-20 lg:mb-[6.25rem]">
                    <h1 className="h1 mb-6">
                        AI Consulting. < br></br>{" "}
                        <span className="inline-block relative text-[5rem] leading-[6.5rem] md:text-[5.5rem] md:leading-[7.5rem] lg:text-[6.5rem] lg:leading-[8.125rem] xl:text-[7.5rem] xl:leading-[9rem]">
                            BRAIN 
                            <Image
                        ...
                        <div className="relative bg-n-8 rounded-[0.875rem]">
                            ...
                            <div className="aspect-[33/40] rounded-b-[0.875rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                                <Image
                                    ...
                                    src="/images/hero/BRAIN_image1_narrow_nosign.jpg"
                                    width={1024}
                                    height={490}
                                    alt="AI"
                                />
