...
import { aiPreparednessQuestions, PreparednessAssessment } from "@/mocks/ai-preparedness-questions";

type QuestionnaireProps = {
    onComplete: (assessment: PreparednessAssessment) => void;
};
...
const Questionnaire = ({ onComplete }: QuestionnaireProps) => {
    ...
    const question = aiPreparednessQuestions[currentQuestion];
    const progress = ((currentQuestion + 1) / aiPreparednessQuestions.length) * 100;
    ...
    const handleNext = () => {
        if (currentQuestion < aiPreparednessQuestions.length - 1) {
    ...
    const handleEmailSubmit = async () => {
        ...
        const assessment: PreparednessAssessment = {
            ...
            currentRole: answers['current-role'] || '',
            industry: answers['industry'] || '',
            aiKnowledge: answers['ai-knowledge'] || '',
            aiExperience: answers['ai-experience'] || [],
            learningGoals: answers['learning-goals'] || [],
            timeCommitment: answers['time-commitment'] || '',
            learningStyle: answers['learning-style'] || [],
            urgency: answers['urgency'] || '',
            challenges: answers['challenges'] || [],
            supportNeeds: answers['support-needs'] || [],
            additionalContext: answers['additional-context'] || ''
        };

        // Send to API
        try {
            await fetch('/api/ai-preparedness/capture', {
                method: 'POST',
                headers: {
                    ...
                    <div className="bg-n-8 rounded-2xl border border-n-6 p-8 md:p-12">
                        <div className="mb-8 text-center">
                            ...
                            <p className="body-2 text-n-3">
                                Please provide your contact information to receive your personalized AI preparedness report and recommendations.
                            </p>
                        </div>
            ...
            <div className="container max-w-[70rem]" ref={questionRef}>
                ...
                <div className="mb-15">
                    <div className="flex items-center justify-between mb-4">
                        <Tagline>Question {currentQuestion + 1} of {aiPreparednessQuestions.length}</Tagline>
                ...
                <div className="bg-n-8 rounded-2xl border border-n-6 p-8 md:p-12">
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        {question.type === 'text' && (
                            <textarea
                                ...
                                placeholder="Share any additional context, challenges, or goals..."
                            />
                        )}
                    </div>
                    ...
                    <div className="flex justify-between pt-6 border-t border-n-6">
                        ...
                        <Button
                            ...
                            white
                        >
                            {currentQuestion === aiPreparednessQuestions.length - 1 ? 'Complete Assessment' : 'Next'}
                        </Button>
                    </div>
                </div>
            </div>
